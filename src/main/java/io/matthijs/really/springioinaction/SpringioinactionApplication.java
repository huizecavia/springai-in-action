package io.matthijs.really.springioinaction;

import io.matthijs.really.springioinaction.boardgamebuddy.GameTitle;
...
public class SpringioinactionApplication {

	private static final Logger LOGGER =
			LoggerFactory.getLogger(SpringioinactionApplication.class);

	public static void main(String[] args) {
		SpringApplication.run(SpringioinactionApplication.class, args);
	}
